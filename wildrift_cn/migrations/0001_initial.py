    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("win_pct", models.DecimalField(decimal_places=4, max_digits=5)),
                ("appear_pct", models.DecimalField(decimal_places=4, max_digits=5)),
                ("forbid_pct", models.DecimalField(decimal_places=4, max_digits=5)),
            ],
            options={
                "ordering": ["win_bzc"],
            },
